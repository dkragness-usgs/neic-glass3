...
TEST(NodeTest, SiteOperations) {
	...
	ASSERT_TRUE(testNode->linkSite(sharedTestSite, sharedTestNode, TRAVELTIME, -1, DISTANCE_FOR_TT));
...
TEST(NodeTest, FailTests) {
	...
	// link fails
	ASSERT_FALSE(testNode->linkSite(nullSite, sharedTestNode, TRAVELTIME, -1, DISTANCE_FOR_TT));
	ASSERT_FALSE(testNode->linkSite(sharedTestSite, nullNode, TRAVELTIME, -1, DISTANCE_FOR_TT));
